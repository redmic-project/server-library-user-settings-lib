...
public class SelectionCheckAvroSchemaTest extends AvroBaseTest {
	...
	public void serializeAndDeserialize_IsSuccessful_IfSchemaAndDataAreCorrect() throws JSONException {
		...
		assertTrue("El objeto obtenido debe ser una instancia de SelectionDTO", SelectionDTO.class.isInstance(result));
