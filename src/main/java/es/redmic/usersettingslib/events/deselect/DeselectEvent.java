...
public class DeselectEvent extends SelectionEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"DeselectEvent\","
				+ "\"namespace\":\"es.redmic.usersettingslib.events.deselect\",\"fields\":["
			+ getSelectionEventSchema() + ","
			+ getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = SettingsEventTypes.DESELECT;
	...
	public DeselectEvent(SelectionDTO selection) {
		super(type);
